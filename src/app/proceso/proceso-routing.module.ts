...
const routes: Routes = [
  {path: 'processlist/:idCapa/:edif/:idSubCapa/:subCapa/:elem/:piso', component: ProcesslistComponent, canActivate: [ CreadorGuard ] },
  {path: 'startprocess/:processdefinitionkey/:idCapa/:edif/:idSubCapa/:subCapa/:elem/:piso', component: StartProcessComponent, canActivate: [AuthGuard] },
