...
@Component({
  selector: 'app-finalizar-obra',
  templateUrl: './finalizar-obra.component.html',
  styleUrls: ['./finalizar-obra.component.css']
})
export class finalizarObraComponent extends ComunTaskComponent implements OnInit, OnDestroy  {
