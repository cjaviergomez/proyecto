...
export class AppComponent implements OnInit, OnDestroy {
	...
	usuario: Usuario;
	notificacionesCount = 0; // Variables para indicar el número de notificaciones que no sean visto.
	...
	notificacionesNoReadedCount(notificaciones: Notificacion[]): void {
